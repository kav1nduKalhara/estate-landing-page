...
const RealEstatePage = () => {
    return (
        <>
            <div id="about" className="relative flex flex-col items-center justify-center mt-16 md:mt-20 lg:mt-24 px-4 md:px-6 lg:px-[328px]">
                <div className="relative flex items-center justify-center w-full max-w-[785px]">
                    <h1 className="text-[#000000] font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-[50px] leading-tight text-center">
            ...
            <div className="relative flex justify-center items-center mt-6 lg:mt-[45px] px-4 lg:px-[97px]">
                <div className="flex flex-col lg:flex-row justify-between w-full max-w-[1245px] bg-[#FFFFFF]">
                    <div className="flex flex-col items-center lg:items-start p-6 lg:p-12 lg:pr-0 lg:max-w-[497px]">
                        ...
                        <div className="flex justify-center gap-8 sm:gap-12 lg:gap-[95px] mt-8 lg:mt-[80px] w-full ">
