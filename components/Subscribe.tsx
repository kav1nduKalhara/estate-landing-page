...
const Subscribe = () => {
    return(
        <div className="relative flex items-center justify-center px-4 sm:px-6 lg:px-8 mt-20 sm:mt-24 lg:mt-[139px] mb-8 sm:mb-12">
            <div className="relative w-full max-w-[1380px] rounded-[15px] min-h-[600px] sm:min-h-[850px] md:min-h-[950px] lg:min-h-[450px]"
                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between p-6 sm:p-8 lg:p-12">
                    <div className="flex flex-col items-center lg:items-start text-center lg:text-left w-full lg:w-3/5 mb-8 lg:mb-0">
                        ...
                        <div className="z-10 mb-6 sm:mb-8 lg:mb-12 max-w-lg lg:max-w-xl">
                        ...
                        <div className="z-10 relative flex w-full max-w-md lg:max-w-lg">
                            <Input
                                type="email"
                            ...
                            />
                            <Button className="absolute top-0 right-0 h-full px-4 sm:px-6 lg:px-8 rounded-full bg-black hover:bg-gray-800 transition-colors">
                    ...
                    <div className="z-0 lg:flex absolute lg:-top-17 top-86 right-0">
